export const AbilitiesText: {[k: string]: AbilityText} = {
	...
	mysticfist: {
		name: "Mystic Fist",
		desc: "This Pokemon's punch attacks have 1.1x power and become Special, Sucker Punch is not changed.",
		shortDesc: "This Pokemon's punch attacks have 1.1x power and become Special.",
	},
	ballin: {
		name: "Ballin'",
